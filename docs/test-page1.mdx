...
updatedAt: Wed May 13 2026 13:34:12 GMT+0000 (Coordinated Universal Time)
---
...
<hint type="info">
  Let's also add a new update here on this document
</hint>
...
Link to another doc from the same space: [Item separator list]()  ✅

Link to another doc from the same space with custom details: [different title, different anchor]() ✅
...
1. [Item separator list]()&#x20;
2. [./syntax/an-item.md]()custom name + anchor + opening in a new tab&#x20;

- [x] [Item separator list]()&#x20;
...
<hint type="info">
  [Item separator list]()  [custom name + anchor]()&#x20;
</hint>
...
<LinkArray contentSource="CUSTOM">
  ...
  <LinkArrayItem>
    [./syntax/an-item.md]()Different title + anchor +opening in a new tab&#x20;
  </LinkArrayItem>
</LinkArray>
...
<WorkflowBlock>
  ...
  <WorkflowBlockItem>
    [./syntax/an-item.md]()Item separator list&#x20;
  </WorkflowBlockItem>
</WorkflowBlock>
...
<Tabs>
  <Tab title="Tab Name">
    ...
    [./syntax/an-item.md]()different title + opening in a new tab&#x20;
  </Tab>
